      ...
      {showMedicalNote ? (
        ...
        >
          ...
          <p className="mt-3 text-sm leading-relaxed text-amber-950/95">
            ...
            потенциально неподходящих продуктов и способов приготовления.
            Приложение не ставит диагнозы и не лечит. Если есть заболевания,
            прием лекарств, анализы или выраженные ограничения, важно
            согласовать питание со специалистом. Для разбора питания и
            безопасных корректировок можно обратиться ко мне, Олесе Богураевой.
          </p>
        </section>
      ) : null}
